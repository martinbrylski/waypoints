...
import de.martinbrylski.wegpunkte.databinding.FragmentWaypointListBinding
import de.martinbrylski.wegpunkte.databinding.WaypointListContentBinding
...
class WaypointListFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val itemDetailFragmentContainer: View? =
            view.findViewById(R.id.waypoint_detail_nav_container)
                ...
                setOnClickListener { itemView ->
                    ...
                    if (itemDetailFragmentContainer != null) {
                        itemDetailFragmentContainer.findNavController()
                            .navigate(R.id.fragment_waypoint_detail, bundle)
                    } else {
